...
class dt_item extends toba_datos_tabla
{
    ...
    function get_extracontable($where=null){
        ...
        CASE WHEN t_f.id_origen_recurso=1 and t_c.tiene_retencion THEN 'SI' ELSE 'NO' END as tiene_reten,CASE WHEN t_f.id_origen_recurso=1 and t_c.tiene_retencion THEN trunc(t_i.monto*t_p.porc_retencion/100,2) ELSE 0 END as retencion,t_f.ano_cobro,
